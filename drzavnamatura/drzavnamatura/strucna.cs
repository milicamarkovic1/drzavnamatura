...
{
    public partial class strucna : Form
    {
        public strucna()
        {
            InitializeComponent();
        ...
        {
            StreamWriter f = new StreamWriter("uceniciStrucna.txt", true);
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < patternsStrucna.brojac; i++)
            {
                if (index == i)
                {
                    ...
                    s5 = patternsStrucna.jezik[index];
                    int pom5 = checkedListBox5.Items.IndexOf(patternsStrucna.jezik[index]);
                    checkedListBox5.SetItemChecked(pom5, true);
                    s3 = patternsStrucna.pr3[index];
                    int pom3 = checkedListBox3.Items.IndexOf(patternsStrucna.pr3[index]);
                    checkedListBox3.SetItemChecked(pom3, true);
                    s2 = patternsStrucna.pr2[index];
                    int pom2 = checkedListBox2.Items.IndexOf(patternsStrucna.pr2[index]);
                    checkedListBox2.SetItemChecked(pom2, true);
                    s1 = patternsStrucna.pr1[index];
                    int pom1 = checkedListBox1.Items.IndexOf(patternsStrucna.pr1[index]);
        ...
        {
            patternsStrucna p = new patternsStrucna();
            p.Show();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            int br = patternsStrucna.brojac;
            for (int i = 0; i < br; i++)
            {
                comboBox1.Items.Add(patternsStrucna.listaimena[i]);
            }
        }
        ...
        {
            richTextBox1.Text = "";
            StreamReader fajl = new StreamReader("uceniciStrucna.txt");
        ...
        {
            StreamWriter fajl = new StreamWriter("uceniciStrucna.txt");
            fajl.Dispose();
            fajl.Close();
            richTextBox1.Text = "";
        }
