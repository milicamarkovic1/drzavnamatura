...
{
    public partial class patternsOpsta : Form
    {
        public patternsOpsta()
        {
            InitializeComponent();
        }
        ...
        public static string[] smer = new string[100];
        ...
        {
            StreamWriter fajl = new StreamWriter("patternsOpsta.txt", true);
            fajl.Write(textBox1.Text);
            fajl.Write(";");
            fajl.Write(comboBox1.SelectedItem.ToString());
            fajl.Write(";");
            fajl.Write(comboBox2.SelectedItem.ToString());
            fajl.Write(";");
            ...
            fajl.Close();
            /*
            StreamReader fajl2 = new StreamReader("patternsOpsta.txt");
            while (!fajl2.EndOfStream)
            {
                richTextBox1.Text += fajl2.ReadLine();
            }
            fajl2.Close();
            */
            s = textBox1.Text + ";" + comboBox1.SelectedItem.ToString() + ";" + comboBox2.SelectedItem.ToString() + ";" + comboBox3.SelectedItem.ToString() + ";" + comboBox4.SelectedItem.ToString() + ";" + comboBox5.SelectedItem.ToString() + ";";
            richTextBox1.Text += s;
            lista[brojac] = s;
            listaimena[brojac] = textBox1.Text;
            jezik[brojac] = comboBox1.SelectedItem.ToString();
            smer[brojac] = comboBox2.SelectedItem.ToString();
        ...
        {
            StreamWriter fajl = new StreamWriter("patternsOpsta.txt");
            fajl.Dispose();
            fajl.Close();
            richTextBox1.Text = "";
            brojac = 0;
        ...
        {
            richTextBox1.Text = "";
            StreamReader fajl = new StreamReader("patternsOpsta.txt");
