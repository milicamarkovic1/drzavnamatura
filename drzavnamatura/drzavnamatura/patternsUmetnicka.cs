...
{
    public partial class patternsUmetnicka : Form
    {
        public patternsUmetnicka()
        {
            InitializeComponent();
        }
        ...
        {
            StreamWriter fajl = new StreamWriter("patternsUmetnicka.txt", true);
        ...
        {
            richTextBox1.Text = "";
            StreamReader fajl = new StreamReader("patternsUmetnicka.txt");
        ...
        {
            StreamWriter fajl = new StreamWriter("patternsUmetnicka.txt");
            fajl.Dispose();
            fajl.Close();
            richTextBox1.Text = "";
            brojac = 0;
